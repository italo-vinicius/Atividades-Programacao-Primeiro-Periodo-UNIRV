# Atividades de Programação e Algoritmos I

Este repositório contém as atividades desenvolvidas em linguagem **C** durante a disciplina de **Programação e Algoritmos I** no curso de **Engenharia de Software** da **Universidade de Rio Verde (UNIRV)**.

## Sobre a disciplina
A disciplina de Programação e Algoritmos I introduz conceitos fundamentais de lógica de programação e desenvolvimento em linguagem C, abrangendo:
...
- **/Aula 2/**: Segunda aula prática da disciplina
- **/Aula 3/**: Terceira aula prática da disciplina
- ...
